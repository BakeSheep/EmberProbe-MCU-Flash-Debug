...
assert.ok(
    !readmeZh.includes("无法加入采样（暂不展开成员）"),
    "Chinese README must not describe composite sampling as unsupported"
);
assert.ok(
    !readmeEn.includes("members are not expanded yet"),
    "English README must not describe composite sampling as unsupported"
);

"use strict";
// 任务1：八个 skills 的操作与证据契约接线校验（结构性，不替代行为验收）。
...
// 八个 skills 必须显式引用共享工作流文档，agent 才能在失败处理时加载统一约定。
assert.strictEqual(manifest.skills.length, 8, "the extension ships eight agent skills");
